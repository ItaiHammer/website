...
export default function AboutMe () {
    ...
    return (<motion.div variants={aboutVariants} initial="initial" animate="animate" id="about-me" >
        <div className="about-me-title-container">
            <h1 className="about-me-title" >About</h1>
            <h1 className="about-me-title" id="purple" onClick={()=>{setAboutMeAnimation(true)}} style={{userSelect: 'none ',cursor: 'pointer'}} >Me</h1>
            <div className="about-circle-icon" ></div>
        ...
        <div className="about-me-about">
            <div className="about-me-text-container">
                ...
                <motion.p className="about-me-text" id="purple" animate={{scale: aboutMeAnimation ? 1.1 : 1}} transition={{duration: 0.2}} >Itai Hammer</motion.p>
                <p className="about-me-text" >I am</p>
                <motion.p className="about-me-text" id="purple" animate={{scale: aboutMeAnimation ? 1.1 : 1}} transition={{duration: 0.2}} >15</motion.p>
                <p className="about-me-text" >years old.</p>
                <p className="about-me-text" >I am into</p>
                <motion.p className="about-me-text" id="purple" animate={{scale: aboutMeAnimation ? 1.1 : 1}} transition={{duration: 0.2}} >Programming,</motion.p>
                <motion.p className="about-me-text" id="purple" animate={{scale: aboutMeAnimation ? 1.1 : 1}} transition={{duration: 0.2}} >Video Editing,</motion.p>
                <motion.p className="about-me-text" id="purple" animate={{scale: aboutMeAnimation ? 1.1 : 1}} transition={{duration: 0.2}} >3D Modeling,</motion.p>
